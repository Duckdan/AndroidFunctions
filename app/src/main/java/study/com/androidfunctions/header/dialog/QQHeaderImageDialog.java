...
public class QQHeaderImageDialog {
     ...
     */
    public QQHeaderImageDialog(Context context, int themeResId, Activity activity) {
    ...
    private void initView() {
        ...
        View inflate = View.inflate(context, R.layout.dialog_header_qq_layout, null);
